...
class TestGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test_group" do
    assert_difference('TestGroup.count') do
      post test_groups_url, params: { test_group: { max_applicants: @test_group.max_applicants, name: @test_group.name } }
    end
  ...
  test "should update test_group" do
    patch test_group_url(@test_group), params: { test_group: { max_applicants: @test_group.max_applicants, name: @test_group.name } }
