...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { adress: @station.adress, flag: @station.flag, max_liters: @station.max_liters } }, as: :json
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { adress: @station.adress, flag: @station.flag, max_liters: @station.max_liters } }, as: :json
    assert_response 200
  end
